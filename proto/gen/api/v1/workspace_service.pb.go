...
const file_api_v1_workspace_service_proto_rawDesc = "" +
	...
	"\x16UpdateWorkspaceSetting\x12+.slash.api.v1.UpdateWorkspaceSettingRequest\x1a\x1e.slash.api.v1.WorkspaceSetting\"@\xdaA\x13setting,update_mask\x82\xd3\xe4\x93\x02$:\asetting2\x19/api/v1/workspace/settingB\xb2\x01\n" +
	"\x10com.slash.api.v1B\x15WorkspaceServiceProtoP\x01Z5github.com/devlopali-dev/slash/proto/gen/api/v1;apiv1\xa2\x02\x03SAX\xaa\x02\fSlash.Api.V1\xca\x02\fSlash\\Api\\V1\xe2\x02\x18Slash\\Api\\V1\\GPBMetadata\xea\x02\x0eSlash::Api::V1b\x06proto3"
