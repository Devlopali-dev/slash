...
const file_api_v1_user_setting_service_proto_rawDesc = "" +
	...
	"\x11UpdateUserSetting\x12&.slash.api.v1.UpdateUserSettingRequest\x1a\x19.slash.api.v1.UserSetting\"L\xdaA\x18user_setting,update_mask\x82\xd3\xe4\x93\x02+:\fuser_setting2\x1b/api/v1/users/{id}/settingsB\xb4\x01\n" +
	"\x10com.slash.api.v1B\x17UserSettingServiceProtoP\x01Z5github.com/devlopali-dev/slash/proto/gen/api/v1;apiv1\xa2\x02\x03SAX\xaa\x02\fSlash.Api.V1\xca\x02\fSlash\\Api\\V1\xe2\x02\x18Slash\\Api\\V1\\GPBMetadata\xea\x02\x0eSlash::Api::V1b\x06proto3"
