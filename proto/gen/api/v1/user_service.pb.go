...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x15DeleteUserAccessToken\x12*.slash.api.v1.DeleteUserAccessTokenRequest\x1a\x16.google.protobuf.Empty\"I\xdaA\x0fid,access_token\x82\xd3\xe4\x93\x021*//api/v1/users/{id}/access_tokens/{access_token}B\xad\x01\n" +
	"\x10com.slash.api.v1B\x10UserServiceProtoP\x01Z5github.com/devlopali-dev/slash/proto/gen/api/v1;apiv1\xa2\x02\x03SAX\xaa\x02\fSlash.Api.V1\xca\x02\fSlash\\Api\\V1\xe2\x02\x18Slash\\Api\\V1\\GPBMetadata\xea\x02\x0eSlash::Api::V1b\x06proto3"
