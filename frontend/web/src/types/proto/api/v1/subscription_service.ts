...
export const SubscriptionServiceDefinition = {
  ...
  methods: {
    ...
    getSubscription: {
      ...
      requestStream: false,
      responseType: Subscription as typeof Subscription,
    ...
    updateSubscription: {
      ...
      requestType: UpdateSubscriptionRequest as typeof UpdateSubscriptionRequest,
      requestStream: false,
      responseType: Subscription as typeof Subscription,
      responseStream: false,
      options: {
    ...
    deleteSubscription: {
      ...
      requestType: DeleteSubscriptionRequest as typeof DeleteSubscriptionRequest,
      requestStream: false,
      responseType: Subscription as typeof Subscription,
      responseStream: false,
      options: {
