...
export const CollectionServiceDefinition = {
  ...
  methods: {
    ...
    listCollections: {
      ...
      requestType: ListCollectionsRequest as typeof ListCollectionsRequest,
      requestStream: false,
      responseType: ListCollectionsResponse as typeof ListCollectionsResponse,
    ...
    getCollection: {
      name: "GetCollection",
      requestType: GetCollectionRequest as typeof GetCollectionRequest,
      requestStream: false,
      responseType: Collection as typeof Collection,
      responseStream: false,
      options: {
        _unknownFields: {
    ...
    getCollectionByName: {
      ...
      requestType: GetCollectionByNameRequest as typeof GetCollectionByNameRequest,
      requestStream: false,
      responseType: Collection as typeof Collection,
      responseStream: false,
      options: {},
    ...
    createCollection: {
      ...
      requestType: CreateCollectionRequest as typeof CreateCollectionRequest,
      requestStream: false,
      responseType: Collection as typeof Collection,
      responseStream: false,
      options: {
    ...
    updateCollection: {
      ...
      requestType: UpdateCollectionRequest as typeof UpdateCollectionRequest,
      requestStream: false,
      responseType: Collection as typeof Collection,
      responseStream: false,
      options: {
    ...
    deleteCollection: {
      ...
      requestType: DeleteCollectionRequest as typeof DeleteCollectionRequest,
      requestStream: false,
