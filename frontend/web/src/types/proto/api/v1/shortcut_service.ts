...
export const ShortcutServiceDefinition = {
  ...
  methods: {
    ...
    getShortcut: {
      name: "GetShortcut",
      requestType: GetShortcutRequest as typeof GetShortcutRequest,
      requestStream: false,
    ...
    getShortcutByName: {
      ...
      requestType: GetShortcutByNameRequest as typeof GetShortcutByNameRequest,
      requestStream: false,
      responseType: Shortcut as typeof Shortcut,
      responseStream: false,
      options: {},
    ...
    getShortcutAnalytics: {
      ...
      requestType: GetShortcutAnalyticsRequest as typeof GetShortcutAnalyticsRequest,
      requestStream: false,
      responseType: GetShortcutAnalyticsResponse as typeof GetShortcutAnalyticsResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [new Uint8Array([2, 105, 100]) as Uint8Array],
