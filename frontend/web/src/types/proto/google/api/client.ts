...
export function flowControlLimitExceededBehaviorProtoToNumber(object: FlowControlLimitExceededBehaviorProto): number {
  switch (object) {
...
function createBaseBatchingSettingsProto(): BatchingSettingsProto {
  return {
    ...
    flowControlLimitExceededBehavior: FlowControlLimitExceededBehaviorProto.UNSET_BEHAVIOR,
  };
}
...
export const BatchingSettingsProto: MessageFns<BatchingSettingsProto> = {
  encode(message: BatchingSettingsProto, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.flowControlLimitExceededBehavior !== FlowControlLimitExceededBehaviorProto.UNSET_BEHAVIOR) {
      writer.uint32(64).int32(flowControlLimitExceededBehaviorProtoToNumber(message.flowControlLimitExceededBehavior));
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.requestByteThreshold = longToNumber(reader.int64());
          continue;
        }
        case 3: {
          if (tag !== 26) {
        ...
        case 8: {
          ...
          message.flowControlLimitExceededBehavior = flowControlLimitExceededBehaviorProtoFromJSON(reader.int32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
